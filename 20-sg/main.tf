...
module "web_alb_sg" {
    source = "git::https://github.com/KalpanaReddyN/terraform-aws-security-group.git?ref=main"
    project_name = var.project_name
    environment = var.environment
...
# frontend should accepts connections from vpn
...
# frontend should accepts connections from web_alb
...
# app_alb should accepts connections from frontend
